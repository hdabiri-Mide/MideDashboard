...
# st.title("📊 enDAQ Vibration Dashboard")
#
# # ================== SIDEBAR ==================
...
#
# show_fft = st.sidebar.checkbox("Show FFT", True)
#
...
#
#     # ================== TABS ==================
#     tab1, tab2, tab3 = st.tabs(["📈 Time Series", "📊 Statistics", "⚡ FFT"])
#
#     # ================== TIME SERIES ==================
#     with tab1:
...
#
#         fig.update_layout(
#             title="Acceleration (Raw vs Moving Average)",
#             height=600
#         )
#
